...
#include "../../half-edge-app/src/Trab2FT.h"
...
void Trab2FT::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData Trab2FT::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Trab2FT::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Trab2FT,
      qt_meta_data_Trab2FT, &staticMetaObjectExtraData }
};
