...
#include "../../half-edge-app/src/Render.h"
...
static const char qt_meta_stringdata_Render[] = {
    ...
    "feedBackBondary(bool)\0w,y\0"
    "updateScreen(int,int)\0recebeArquivo(QString)\0"
};
...
void Render::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->feedBackBondary((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->updateScreen((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 3: _t->recebeArquivo((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 1
void Render::feedBackBondary(bool _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
